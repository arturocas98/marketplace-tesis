export const environment = {
  production: true,
  url_image : "http://organic-gye.com/assets/",
  ...
  server:'http://organic-gye.com/marketplace-tesis/src/assets/img/index.php?key=AIzaSyAhIFsYyuMjThfQhH_2IQnI3yUR9LgdVsg',
  serverDelete : 'http://organic-gye.com/marketplace-tesis/src/assets/img/delete.php?key=AIzaSyAhIFsYyuMjThfQhH_2IQnI3yUR9LgdVsg',
  email:'http://organic-gye.com/marketplace-tesis/src/assets/email/index.php?key=AIzaSyAhIFsYyuMjThfQhH_2IQnI3yUR9LgdVsg'
